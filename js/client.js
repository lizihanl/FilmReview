...
ready(function() {
    ...
    document.querySelector("#btn_login").addEventListener("click", function(e) {
        ...
        // ajaxPOST("/login", function(data) {                              // post换成此行
        ajaxGET("/login?"+queryString, function(data){                      //get换成此行   注意URL部分：？后跟发给后台的数据
            if(data) {
        ...
        // }, queryString);                         //post换成此行
        
        });              //get换成此行
    });

    // ajaxGET("/profile", function(data) {
    ...
    //         }
    //     }
    //     // let div = document.getElementById("dataContent");
    //     // div.getElementsByTagName("li")[0].innerHTML=parsedData;
    // }, "GET");
